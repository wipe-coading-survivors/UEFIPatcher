...
* [ ] **Терминальный рендер: цвет как на rd450x** — на rd450x (полный
  ...
  **Вердикт E33 (2026-09-07) — негатив, откат на E32**: serial
  ...
  (ii) опровергнуто статикой, гипотезы A/B/C). Следующий шаг — S4b:
  додизасм SimpleTextOut TermSrc + кандидат-дискриминатор E34 без
  glue. Цвет на E32-базе — через путь (б) или патч рендера, после
  S4b-дискриминации.
