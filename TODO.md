...
* [x] **Resolution 2026-09-13 (движок, CLI):** qid подтверждён живым
  ...
  **v4 (2026-09-13, исправление базы):** v2/v3 строились на pristine
  ...
  Форензика: шаблон копии нёс 0x531=04 (x16), 0x532=03 (x8x8) —
  следы AMIBCP-правок владельца от 2026-09-03; закрыт и старый
  феномен «AMIBCP правит — не применяется» (применялось, но
