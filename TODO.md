...
* [ ] **TUI: команда `:nvar list/set`** — NVRAM-правки сейчас только в CLI
  (`uefi-cli nvar set`; живая сессия 2026-09-21 задействовала его для
  Timeout, хотя позже выяснилось, что он HII-вопрос 1031:0x4 и печётся из
  Forms View). В TUI ни команды, ни записи в хелпе нет — завести команду
  + хинт/хелп; кандидат мини-цикла.
