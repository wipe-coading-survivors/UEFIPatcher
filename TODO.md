...
## Аппаратная валидация unhide на Huananzhi X99-TF (2026-09-02..03): ЗАВЕРШЕНА УСПЕХОМ
...
* [ ] **ENGINE: пустые подписи раскрытой формы — PRC-теория
...
### Мини-цикл «unlock-op» (engine): unlock вопроса/страницы — кандидат следующим
...
* [ ] **u1. Карта гейтинга (только чтение)** — для цели (REF→form_id или
...
* [ ] **u2. Операция unlock (правка)** — флип литерала на недостижимый:
...
* [ ] **u3. Ревизия UPG/PRC-механики** — теория PRC-токенов фальсифицирована
...
* [ ] **u4. Real-image gate** — `tests/real_image.rs`: unlock страницы PCI
  ...
  round-trip.
* [ ] **u5. CLI** — команды вида `hii form unlock` / `hii question unlock`
