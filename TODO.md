...
* [ ] **uefi-engine: позиционная вставка REF/вопроса — IntelRCSetup
  ...
  QuestionId 0, последовательные ненулевые qid. Готовится v2:
  emit_ref3 → нативный AMI-паттерн, схема qid 301 (первый свободный
  ≥7), insert_before goto 10009 (вариант Б); если не отрисуется —
