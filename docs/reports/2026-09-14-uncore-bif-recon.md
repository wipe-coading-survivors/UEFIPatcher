...
Хозяин вшил v22 (TMM), F9 + ребут. Срез (ssh <rig-ip: см. AGENTS.md/IPMI-rd450x.txt>):
...
Метод: ssh root@<rig-ip: см. AGENTS.md/IPMI-rd450x.txt>, python mmap /dev/mem r+b, поштучные
