...
(0xFF-скан + движковая сверка тома) ≈ 99× потребности S2 21 078 Б
(rd450x-экстракты 13 361/13 403 + 7 675 по донору + выравнивание;
прецедент фактической вставки 25 294 Б); (2) том диспетчеризуем по
...
3. **Карта оффсетов CR-полей LIVE Setup** (для S4-а/(в)): снять с IFR
...
5. **Терминальный тип владельца** для E30-приёмки (PCD=3 VT-UTF8 —
   ...
   валидации S2).
6. Методические: Tiano-compression слепое пятно (C275-PE32, §4.1) — не
