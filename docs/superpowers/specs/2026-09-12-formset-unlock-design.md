...
> **Fix 2026-09-13 (живой `hii question info`):** qid-колонка исходной
> таблицы (0x242…0x281) была неверна; offsets и структура IIO 0..3
> верны. Формы 118/119/422/423 — четыре IIO-страницы с GOTO на
> Socket-0-подстраницы портов (формы 83–93); вопрос владельца
> «IOU0 (IIO PCIe Port 2)» = **qid 0x248 @ 0x531** (вторая и третья
> копии той же страницы — 0x25d@0x532 / 0x271@0x533 / 0x285@0x534,
> сокет-экземпляры). NPP-вопросы (0x259 «IOU0 Non-Posted Prefetch»
> и т.п.) живут на 0x1758+, не в бифуркационной зоне.
