...
- **S4a** — резерв (а): полный AMI TermSrc (цвет; решение владельца
  ...
  побайтно верифицирован) — фоллбэк. Кандидат E33 = цепочка E32 с
  заменой TerminalDxe → непатченный донорский TermSrc + glue v3 —
  план `docs/superpowers/plans/2026-09-06-serial-s4a-termsrc-swap.md`
