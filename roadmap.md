...
- **S4** — AMI-стек TermSrc+SerialIo с починенной привязкой (основной
  ...
  **Закрыта (вердикт E32, 2026-09-06)**: бут с первого раза, baud
  ...
  переезд порта консоль пережила (контраст: на E31 та же операция
  клинила до CMOS-сброса; полный позитив 0x2F8 недоступен — один
  физический разъём); Terminal Type инертен (косметика, rd450x-референс
  цветного вывода). Отчёты:
  `docs/reports/2026-09-06-serial-s4-e32-pack.md` (кандидат sha256
  `8def2850…`),
  `docs/reports/2026-09-06-serial-s4-e32-verdict.md` (вердикт + §4
  опциональные дискриминаторы A/B применения PNP0501_0_NV[1]).
