...
- **NP-P** — пре-чеки движка (TDD-план — после ревью спеки и NP-R):
  ref-вопрос в `hii question add` (OP_REF уже в ifr_builder),
  райтер регистрации страницы $SPF (нулевой слот @0x354 + count@0x60 +
  bump — поверх доказанных E31 примитивов spf.rs), real-image гейт
  дуги. Статус: не начата.
