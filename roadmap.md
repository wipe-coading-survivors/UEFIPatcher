...
- **S4a** — резерв (а): полный AMI TermSrc (цвет; решение владельца
  ...
  `docs/reports/2026-09-06-serial-s4a-e33-pack.md`; протокол приёмки:
  (a) живая консоль 115200 8N1, (b) цвет ANSI-SGR (эталон rd450x),
  (c) q512-baud. Готов к прошивке (владелец).
