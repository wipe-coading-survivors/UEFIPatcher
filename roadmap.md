...
- **S3** — настройки serial в Setup (hijack/append + varstore; эталон
  ...
  Terminal Type применяется без видимых отличий. «Несохранение» =
  тихий save без RESET_REQUIRED (наши флаги 0x00 vs нативные 0x10);
  COM-переезд-клин — находка S2 (фикс 0x3F8) → S4. Отчёты:
