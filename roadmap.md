...
- **S3** — настройки serial в Setup (hijack/append + varstore; эталон
  геометрии $SPF — MNX99MR9A). **В ожидании E31**: кандидат собран и
  провалидирован — отчёт `docs/reports/2026-09-06-serial-s3-e31-pack.md`
  (кандидат sha256 `d30cca1c…`, состав = S2-тройка с config-aware glue +
  2 вопроса 3/28/1/0#10019 q512/q513; протокол приёмки §4, вердикт
  прошивки — за владельцем).
